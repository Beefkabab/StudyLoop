...
export default function ParticipantDashboard() {
  ...
  const [activeTab, setActiveTab] = useState<"applications" | "saved" | "reminders">("applications");
      ...
      <div className="bg-white border-b border-slate-200 py-8">
        <div className="container">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="space-y-1">
              ...
              <p className="text-xs sm:text-sm text-slate-500">
                Track your active applications, scheduled appointments, and saved research opportunities.
              </p>
            </div>
          ...
          <div className="grid grid-cols-3 gap-3 sm:gap-4 mt-6">
            ...
            <div className="p-4 bg-slate-50 rounded-xl border border-slate-200">
              <div className="flex items-center justify-between">
                <span className="text-xs font-semibold text-slate-600">Upcoming Reminders</span>
          ...
          <div className="flex gap-2 mt-6 border-b border-slate-200 pb-px">
            ...
            >
              Saved Studies ({savedStudies?.length || 0})
            </button>
            <button
            ...
            >
              Reminders & Checklists ({reminders?.length || 0})
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="container mt-6">
        {activeTab === "applications" && (
          <div className="space-y-4">
            {appsLoading ? (
              <div className="p-8 text-center text-xs text-slate-400">Loading your applications...</div>
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-12 text-center space-y-3">
                ...
                <h3 className="font-bold text-slate-800 text-base">No study applications yet</h3>
                <p className="text-xs text-slate-500 max-w-sm mx-auto">
                  When you apply to studies using your 2-minute pre-screener, they will appear here with live coordinator feedback.
                </p>
                <Link href="/browse">
                  <Button size="sm" className="bg-sky-600 hover:bg-sky-700 text-white text-xs">
                    Explore Paid Studies
                  </Button>
                </Link>
              </div>
            )}
          ...
          <div className="space-y-4">
            {savedLoading ? (
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-12 text-center space-y-3">
                ...
                <p className="text-xs text-slate-500 max-w-sm mx-auto">
                  Bookmark studies while browsing to compare compensation, schedules, and locations before applying.
                </p>
                <Link href="/browse">
          ...
          <div className="space-y-3">
            {remindersLoading ? (
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-12 text-center space-y-3">
                ...
                <p className="text-xs text-slate-500 max-w-sm mx-auto">
                  Reminders for fasting requirements, appointment times, and follow-up logs will appear here.
                </p>
              </div>
            )}
          </div>
